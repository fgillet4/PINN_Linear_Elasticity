...
# Create new virtual environment in the current directory (pytorch_gpu/)
Write-Host "📦 Creating new virtual environment in current directory..." -ForegroundColor Cyan
python -m venv venv_pytorch_gpu

# Activate virtual environment (from current directory)
...
Write-Host "   cd pytorch_gpu  # Make sure you're in the gpu folder" -ForegroundColor Gray
...
Write-Host "   • Virtual environment is located in: .\venv_pytorch_gpu\" -ForegroundColor Gray
Write-Host ""